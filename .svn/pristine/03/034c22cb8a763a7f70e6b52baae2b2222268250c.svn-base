...
class RnPbccXxhzbdbTest(InitCls, BsclMainKeyword, PubKeywordForBb, BsglPubBsrwKeyword, BsglMainKeyword):

    def test_01_pbcc_xxhzbdb(self):
        """人行报表--线下汇总表对比页面"""
        ...
        self.addBsrwSave()
        # 7、点击主菜单--报送处理，进入pbcc线下汇总表对比界面
        self.RefreshPage()
        self.clickBsclMainMenue()
        self.intoPbccXxhzbdbPage()
        # 8、未导入数据--点击对比-给出提示信息
