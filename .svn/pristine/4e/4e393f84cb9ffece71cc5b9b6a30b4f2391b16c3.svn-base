...
class PtszCwgsElementFrame(object):
    """平台设置-财务公司菜单相关frame"""
    MAIN_FRAME = "ifrSetings010101"  # 平台设置页面主框架frameID
    ...
    JJCF = "//*[@id='ORG_ECONOMIC_SECTOR']/option[text()='集体控股企业']".__add__(XPATH)  # 经济成分
    QYGM = "//*[@id='ORG_ENTERPRISE_SCALE']/option[text()='大型']".__add__(XPATH)  # 企业规模
    ZFHH = "//*[@id='ORG_PAYBANKNO']".__add__(XPATH)  # 支付行号
    JYZT = "//*[@id='ORG_STATUS']/option[text()='正常']".__add__(XPATH)  # 经营状态
    CKZBJJCFS = "//*[@id='DEPOSIT_RESERVE_WAY']/option[text()='不缴存']".__add__(XPATH)  # 存款准备金缴存方式
    SFSS = "//*[@id='LISTED_STATUS']/option[text()='是']".__add__(XPATH)  # 是否上市
    ## 注册信息
    CLRQ = "//*[@id='ORG_DAYOFESTB']".__add__(XPATH)  # 成立日期
    ZCDQ_S_ZXS = "//*[@id='ORG_PROVINCE']/option[text()='北京市']".__add__(XPATH)  # 注册地区-省/直辖市
    ZCDQ_S_Q = "//*[@id='ORG_AREA']/option[text()='东城区']".__add__(XPATH)  # 注册地区-市/区
    ...
    FDDBR_ZJLB = "//*[@id='ORG_LRCERTTP']/option[text()='身份证']".__add__(XPATH)  # 证件类别
    FDDBR_ZJHM = "//*[@id='ORG_LRCERTNO']".__add__(XPATH)  # 证件号码
    ##主要负责人（EAST报送）
    ZYFZR_XM = "//*[@id='ORG_MPNAME']".__add__(XPATH)  # 姓名
    ZYFZR_ZJLB = "//*[@id='ORG_MPCERTTP']/option[text()='身份证']".__add__(XPATH)  # 证件类别
    ...
    SJKZR_FRAME = "layui-layer-iframe1"  # 实际控制人页面框架frameID
    SJKZR_MC = "//*[@id='ACT_NAME']".__add__(XPATH)  # 名称
    SJKZR_ZJLX = "//*[@id='ACT_TTP']/option[text()='身份证']".__add__(XPATH)  # 证件类型
    SJKZR_ZJHM = "//*[@id='ACT_TNO']".__add__(XPATH)  # 证件号码
    SJKZR_BC = "//*[@class='icon icon_save']".__add__(XPATH)  # 保存
    SJKZR_QD = "//*[@class='layui-layer-btn0']".__add__(XPATH)        # 确定
    QD_FRAME ="ifrmcontent"
    ##财务公司股东信息
    CWGSGDXX_XZ = "//*[@onclick='openOrgGDXXDetailPage(this)']".__add__(XPATH)  # 新增
    CWGGGDXX_FRAME = "layui-layer-iframe3"  # 财务公司股东信息页面框架frameID
    ##财务公司股东信息-基本信息
    ...
    CWGSGDXX_SSHY = "//*[@id='SHH_BUSINESS']/option[text()='A0111-稻谷种植']".__add__(XPATH)  # 所属行业
    CWGSGDXX_GDZT = "//*[@id='SHH_STATE']/option[text()='是']".__add__(XPATH)  # 股东状态
    CWGSGDXX_ZJLB = "//*[@id='SHH_TTP']/option[text()='0-身份证']".__add__(XPATH)  # 证件类别
    ...
    CWGSGDXX_JLR = "SHH_NET_PROFIT".__add__(ID)  # 净利润
    ##财务公司股东信息-持股信息
    CWGSGDXX_RGRQ = "//*[@id='SHH_JOIN_DATE']".__add__(XPATH)  # 入股日期
    CWGSGDXX_CZE = "//*[@id='SHH_AMOUNT']".__add__(XPATH)  # 出资额
    CWGSGDXX_CGBL = "//*[@id='SHH_RATIO']".__add__(XPATH)  # 持股比例
    TZQTJRJGBZ = "//*[@id='SHH_INVEST_MARK']/option[text()='是']".__add__(XPATH)  # 投资其他金融机构标志
