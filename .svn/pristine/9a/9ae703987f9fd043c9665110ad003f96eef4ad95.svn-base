...
class Rn1104MainProcessTest(InitCls, BsclMainKeyword, PubKeywordForBb, BsglPubFzglKeyword, BsglPubBssqKeyword,
                            BsglPubSplcKeyword, BsglPubBsrwKeyword, BsglMainKeyword, BsglPubBbmbKeyword):
    ...
    def test_01_1104_main_process(self):
        ...
        self.addGroup(group_name, user_chinese_name, "自动化测试_1104分组描述")
        # 编辑管理员分组，把登录用户添加为管理员
        self.addUserForAdminGroup()
        # 7、分组授权
        ...
        self.searchBsnr("G0102-201-第Ⅱ部分：贷款质量五级分类情况简表")
        ...
        self.swithToBsrw()
        self.switchBspzFrame()
        response = self.queryBsrw(bsqj, bsnr_name)
        if response:
        ...
        # end_date = '2022-06-30'
        self.inputSbSjrqForBb("ifrRMM030103")
        self.inputReportNoForBb(bbbh)
        self.choiceReportDateForBb(bsqj)
        self.clickRefreshButtonForBb()
        self.tickAllBoxForBb()
        ...
        # start_date = '2022-06-30'
        # end_date = '2022-06-30'
        self.inputCxSjrqForBb("ifrRMM030104")
        self.choiceReportDateForBb(bsqj)
    ...
    def test_03_1104_go_back_task(self):
        ...
        for handle in all_handle:
            if handle != main_handle:
                ...
                self.goBackSuccForBb("1104自动化退回")
