...
# @Author   : yangshukun
# @File     : case_pbcc_main_process.py
...
class RpbccMainProcessTest(InitCls, BsclMainKeyword, PubKeywordForBb, BsglPubFzglKeyword, BsglPubBssqKeyword,
                           BsglPubSplcKeyword,
    ...
    def test_01_pbcc_main_process(self):
        ...
        self.inputSbSjrqForBb("ifrRMM030803")
        self.choiceReportDateForBb(bsqj)
        self.inputReportNoForBb(bbbh)
        self.clickRefreshButtonForBb()
        self.tickAllBoxForBb()
        ...
        # 27、搜索对应报送任务，批量导出
        self.inputCxSjrqForBb("ifrRMM030804")
        self.choiceReportDateForBb(bsqj)
    ...
    def test_02_pbcc_audit_refused(self):
        ...
        self.swithToBsrw()
        self.switchBspzFrame()
        self.queryBsrw("2022年第一季度", "A1302")
        res = self.GetTagText(self.COUNG_QUERY_RESULT_BSRW)
        if res != "共有 0 个报送任务，0 个已过期":
            self.abandonBsrw("pbcc任务自动化废弃")
        # 17、新增报送任务
        ...
        self.clickRefreshButtonForBb()
        self.tickAllBoxForBb()
        self.inputAuditReasonForBb("自动化PBCC报表审批驳回")
