...
class BsclMainMenueElement(object):
    ...
    BUTTON_BSPZ_RIMAS = "//li[@id='RMM03']/div[@class='menu_2']//a[text()='{}' and starts-with(@menuid,'RMM-Web120101')]".__add__(
        XPATH)  # 报送处理--报送品种不同页面的公共按钮
    TAG_BSPZ_COMMON = "//*[@class='desk-menu-list']/ul/li[@class='tagFocus']/a[text()='{}']".__add__(
        XPATH)  # 报送处理--报送品种不同页面的标题栏页签
    ...
    TAG_BSPZ_RAMLLT_HD = "//li[starts-with(@menuid,'RAMLLT-Web01010101')]/a[text()='{}']".__add__(
        XPATH)  # 报送处理--报送品种不同页面的标题栏页签
    TAG_BSPZ_RAMLLT_SP = "//li[starts-with(@menuid,'RAMLLT-Web01010102')]/a[text()='{}']".__add__(
        XPATH)  # 报送处理--报送品种不同页面的标题栏页
    TAG_BSPZ_RAMLLT_SB = "//li[starts-with(@menuid,'RAMLLT-Web01010103')]/a[text()='{}']".__add__(
        XPATH)  # 报送处理--报送品种不同页面的标题栏页
    TAG_BSPZ_RAMLLT_CX = "//li[starts-with(@menuid,'RAMLLT-Web01010104')]/a[text()='{}']".__add__(
        XPATH)  # 报送处理--报送品种不同页面的标题栏页
    KQDB = "//li[@class='menu_3 ui-draggable ui-draggable-handle']/h5[text()='{}']/..//a[text()='跨期对比']".__add__(
        XPATH)
    BUTTON_DIFF_BSPZ_COMMON = "//h5[text()='{}']/..//a[text()='{}']".__add__(
        XPATH)  # 报送处理，根据品种选择对应页面，两个占位符{}，前面传品种，后面传标签页。"//h5[text()='1104']/..//a[text()='线下报表对比']"
...
class ZhbbMainMenueElement(object):
    ...
    XXHZBDB_TAB = "//a[@menuid='RPTC-Web010707']".__add__(XPATH)  # 线下汇总表对比标题菜单
    XXHZBDB_TAG = "//li[@menuid='RPTC-Web010707']".__add__(XPATH)
...
class BsclMainFrame(object):
    ...
    RN1104_XXHZBDB_MAIN_FRAME = 'ifrRMM030107'  # 1104线下汇总表对比主框架ID
    RN1104_KQDB_MAIN_FRAME = 'ifrRMM030108'  # 1104跨期对比对比主框架ID
    ...
    RPBCC_XXHZBDB_MAIN_FRAME = 'ifrRMM030807'  # 人行报表线下汇总表对比主框架ID
    RPBCC_KQDB_MAIN_FRAME = "ifrRMM030808"  # 人行报表跨期对比对比主框架ID
    ...
    RFBS_KQDB_MAIN_FRAME = "ifrRMM-Web01010105"  # 金数跨期对比对比主框架ID
    ...
    RPTC_XXHZBDB_MAIN_FRAME = "ifrRPTC-Web010707"  # 综合报表线下汇总表对比主框架ID
    ...
    # 反洗钱大核对、审批、上报、查询页面主框架
    RAMLLT_HD_MAIN_FRAME = "ifrRAMLLT-Web01010101"  # 反洗钱大额核对主框架ID
    RAMLLT_SP_MAIN_FRAME = "ifrRAMLLT-Web01010102"  # 反洗钱大审批主框架ID
    RAMLLT_SB_MAIN_FRAME = "ifrRAMLLT-Web01010103"  # 反洗钱大上报主框架ID
    RAMLLT_CX_MAIN_FRAME = "ifrRAMLLT-Web01010104"  # 反洗钱大查询主框架ID
...
class PubBbBspzElement(object):
    ...
    PUB_REPORT_DATA_BB = "//*[@class='reportRangeList']"
    ...
    MSG_PUB_BB_1 = "//div[@class='   aui_state_focus aui_state_lock']//div[@class='aui_content']".__add__(
        XPATH)  # 报表类--通用弹窗--提示信息
    ...
    BOX_PUB_CHOOSE_ALL_DEJK = "//*[@id='fixed_title']/thead[1]//span[@class='checkbox_bg']".__add__(
        XPATH)  # 报表类-任务列表全选根节点（不包括查询）-大额监控核对
    BOX_PUB_CHOOSE_ALL_DEJK_SP = "//*[@id='fixed_title']//th[1]//span[@class='checkbox_bg']".__add__(
        XPATH)  # 报表类-任务列表全选根节点（不包括查询）-大额监控审批
    ...
    BUTTON_PUB_BBXQ_BB = "//table[@id='listTable']/tbody/tr[3]/td[last()]/a[text()='报表详情']".__add__(
        XPATH)  # 报表类--报送任务列表--报表详情按钮
    BUTTON_PUB_BSJD_BB = "//table[@id='listTable']/tbody/tr[3]/td[last()]/a[text()='报送进度']".__add__(
        XPATH)  # 报表类--报送任务列表--报送进度按钮
    BUTTON_LJJY = "//*[@class='aui_state_highlight']".__add__(XPATH)  # 立即校验按钮
    BUTTON_PUB_GOBACK_BB = "//*[@id='backButton']".__add__(XPATH)  # 报表类--报表详情--退回按钮
    FRAME_PUB_GOBACK_BB = "//iframe[starts-with(@id,'LAYOUT_WIN_/SmartPage/RMM-Web@Pub_Go_BackPage')]".__add__(
        XPATH)  # 报表类--退回窗口FRAME
    FRAME_PUB_GOBACK_RESON_ALERT_BB = "//iframe[starts-with(@id,'LAYOUT_WIN_/SmartPage/goBackReason')]".__add__(
        XPATH)  # 报表类--退回原因填写窗口FRAME
    ...
    INPUT_PUB_SB_START_DATE_BB = "//*[@class='startDate Wdate']".__add__(XPATH)  # 上报页面 - 数据日期-开始日期
    CLEAR_SJ_DATE = "//*[@id='dpClearInput']".__add__(XPATH)  # 清空按钮
    SJ_DATE_FRAME = "//*[@id='_my97DP']/iframe".__add__(XPATH)  # 数据日期frame
    INPUT_PUB_SB_END_DATE_BB = "//*[@class='endDate Wdate']".__add__(XPATH)  # 上报页面 - 数据日期-结束日期

    """报表类--线下汇总表对比页面"""
    BUTTON_COMPARE = "compareButton".__add__(ID)  # 对比按钮
    BUTTON_IMPORT = "importButton".__add__(ID)  # 导入按钮
    BUTTON_CLEAN = "cleanButton".__add__(ID)  # 清空按钮
    BUTTON_DELETE = '//*[@class="color_blue btnShow"]'.__add__(XPATH)  # 删除按钮
    FILE_PATH = "D:\\DcabAtuoTest\\data\\补录\\1-财务信息\\1-会计科目.xlsx"  # 导入文件路径
    MAS_COMPARE_NULL_TS = "//*[@class='layui-layer-content layui-layer-padding']".__add__(
        XPATH)  # 未导入点击对比--提示--请先导入文件再进行对比。
    BUTTON_COMPARE_TS_SURE = "//*[@class ='layui-layer-btn0']".__add__(XPATH)  # 未导入点击对比--提示--点击确定按钮
    MAS_CLEAN_TS = "//*[@class='layui-layer-content layui-layer-padding']".__add__(XPATH)  # 点击清空--提示--是否清空所有文件。
    MAS_DELETE_TS = "//*[@class='layui-layer-content layui-layer-padding']".__add__(XPATH)  # 点击删除--提示--是否删除当前文件。
    BUTTON_TS_SURE = "//*[@class='layui-layer-btn0']".__add__(XPATH)  # 提示信息页--点击是
    MAS_CLEAN_DATE = "mainTotal".__add__(ID)  # 断言清空后--共有 0 条数据
    BUTTON_TS_NO = "//*[@class='layui-layer-btn1']".__add__(XPATH)  # 提示信息页--点击否
    BUTTON_SELECT_BSNRMC = "//*[@class='layui-edge']".__add__(XPATH)  # # 点击报送内容名称下拉列表
    SELECT_BSNRMC = "//*[@lay-value='{}']".__add__(XPATH)  # 选择报送内容名称，传参使用{}占位
    IMPORT_FRAME = "//iframe[contains(@id,'layui-layer-iframe')]".__add__(
        XPATH)  # 对比页面frame
    BUTTON_DB_REFRESH = "refreshButton".__add__(ID)  # 对比页面-刷新
    BUTTON_DB_DOWNLOAD = "downloadButton".__add__(ID)  # 对比页面-导出
    BUTTON_SELECT_DBLWXS = "//label[text()='对比小数位数']/..//i[@class='layui-edge']".__add__(
        XPATH)  # 点击对比小数位数下拉列表
    SELECT_DBLWXS = "//dl[@class='layui-anim layui-anim-upbit']/dd[text() = '{}']".__add__(
        XPATH)  # 选择对比小数位数：两位小数，实际小数位数，使用{}占位传参
    INPUT_DBDATA = "compareDate".__add__(ID)  # 对比日期
    BUTTON_SELECT_QZFS = "//label[text()='取值方式']/..//i[@class='layui-edge']".__add__(
        XPATH)  # 点击取值方式下拉列表
    SELECT_QZFS = "//dl[@class='layui-anim layui-anim-upbit']/dd[text() = '{}']".__add__(
        XPATH)  # 选择取值方式：最后一次报送数据，首次报送数据，使用{}占位传参
    CLOSE_DB_PAGE = "//*[@class='layui-layer-ico layui-layer-close layui-layer-close1']".__add__(XPATH)  # 关闭对比页面
...
class PubMxBspzElement(object):
    ...
    MSG_RAMLLT_MX = "//body[@class='PAGE_BODY']/div[1]//div[@class='aui_content']".__add__(XPATH)  # 反洗钱大额--通用弹窗--提示信息
    ...
    IMG_PUB_HD_CHECK_FLAG_MX = "//table[@id='pub_check_page_list']/tbody/tr[{}]/td[2]/span/span/img".__add__(
        XPATH)  # 明细类--核对页面--校验结果图标
    BOX_ONE_PUB_MX = "//table[@id='pub_check_page_list']/tbody/tr[{}]/td[1]/span/span".__add__(XPATH)  # 根据数据行索引，点击复选框
    DATA_PUB_REFUSE_RESON_MX = "//table[@id='pub_check_page_list']/tbody/tr[1]//input[@id='pub_check_page_list.rejectReason']".__add__(
        XPATH)  # 明细类--核对页面--驳回意见
    DATA_DEJK_RESON_MX = "//*[@id='lcts_dataReportTask_list.total']".__add__(XPATH)  # 大额监控--核对页面--驳回意见
    ...
    BUTTON_PUB_SAVE_FOR_INFORMATION_MX = "//li[@class='icon icon_save show_btn btn_save']".__add__(
        XPATH)  # 明细类--进入办理-新增--保存按钮
    ...
    BUTTON_PUB_SB_DOWN_LOAD_MX = "pub_result_page_list.downLoadTxt".__add__(ID)  # 明细类--上报页面-下载按钮
    BUTTON_PUB_SB_DOWN_LOAD_MX1 = "//*[@id='pub_report_page_list.download']".__add__(XPATH)  # 明细类--上报页面-下载按钮
    BUTTON_PUB_SB_QRCG_MX = "pub_report_page_list.report".__add__(ID)  # 明细类--上报页面-上报按钮
    BUTTON_PUB_SB_QRCG_MX1 = "//*[@id='pub_report_page_list._um_agree']".__add__(XPATH)  # 明细类--上报页面-确认成功按钮
    ...
    FRAME_PUB_SB_BACK_MX = "//iframe[starts-with(@id,'layui-layer-iframe')]".__add__(
        XPATH)  # 明细类--报送任务--任务详情--退回窗口frame框架
    ...
    FRAME_PUB_SB_BACK_RESON_ALERT_MX = "//iframe[starts-with(@id,'LAYOUT_WIN_/SmartPage/goBackReason')]".__add__(
        XPATH)  # 明细类--报送任务--任务详情--退回窗口--退回原因frame框架
    ...
    BUTTON_PUB_CX_DOWN_LOAD_MX = "//input[@value='批量导出(excel)']".__add__(XPATH)  # 明细类--查询页面-批量导出(excel)
